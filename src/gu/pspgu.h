 ...
 *
 * @brief The Graphics Utility Library (GU) is a library for 3D graphics programming.
 *
 * The Graphics Utility Library (GU) is a library for 3D graphics programming.
 * It provides a set of functions for setting up the graphics environment,
 * rendering 3D objects, and handling input and output.
 *
 */
...
**/
void* sceGuSetCallback(int signal, void (*callback)(int, const void *));
...
/**
  ...
  * @param numStacks - Number of stacks to use
